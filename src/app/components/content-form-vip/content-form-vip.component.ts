...
@Component({
  selector: 'app-content-form-vip',
  templateUrl: './content-form-vip.component.html',
  styleUrls: ['./content-form-vip.component.css']
})
export class ContentFormVipComponent implements OnInit {
